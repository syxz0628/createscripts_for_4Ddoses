    ...
    def fun_create_4D_dose_recon_exec(self):
        ...
        for specific_plan in range(0, len(self.motioninfo.planName)):
            ...
            for temp in range(0, int(self.motioninfo.fieldNo[specific_plan])):
                Plan_field_info = Plan_field_info+'field ' + str(temp + 1) + ' / read rst(' + self.path2patientData + \
                ...
                # bolus information to field
                if self.motioninfo.bolus[specific_plan][temp]=='0':
                    Plan_field_info=Plan_field_info+'bolus(0) \n'
                else:
                    Plan_field_info = Plan_field_info + 'bolus(' + self.motioninfo.bolus[specific_plan][temp] + ') \n'
                # motion information to field
