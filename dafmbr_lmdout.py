...
class class_dafmbr_lmdout_script():
    ...
    def fun_create_lmdout_sh(self):
        ...
        createsh='/u/ysheng/MyAIXd/projects/patients/commands/04_makemposlmdout_local.sh'
                ...
                for dafNo in self.motioninfo.dafinfo[patientNo]:
                    ...
                    for MBRNo in self.motioninfo.mbrinfo[patientNo]:
                        ...
                        if dafNo[:8] in checkMBRdate:
                            ...
                            writesh.writelines(
                                path2script + path2daf + ' -m ' + path2MBR + ' -l ' + lmdoutfilename + ' -o ' + mposfilename +' -g /u/ysheng/MyAIXd/projects/patients/commands/lmdout_logfile.log'+ os.linesep)
                    NoofMBRinplan=0
