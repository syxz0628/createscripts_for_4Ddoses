import os
import sys
def fun_copy_combine_logfiles(write_sh_name,writetype,combine_log_name,path2logfiles,endwithN):
    ...
    with open(write_sh_name, writetype) as log_file:
        ...
        log_file.writelines(
            'find ' + combine_log_path + ' -name "*' + endwithN + '" | xargs cat > ' + combine_log_name + '\n')
